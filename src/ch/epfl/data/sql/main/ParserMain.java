...
import ch.epfl.data.sql.optimizers.index.IndexRuleOptimizer;
import ch.epfl.data.sql.optimizers.index.IndexSimpleOptimizer;
import ch.epfl.data.sql.optimizers.name.NameCostOptimizer;
import ch.epfl.data.sql.optimizers.name.NameManualOptimizer;
import ch.epfl.data.sql.optimizers.name.NameManualParOptimizer;
import ch.epfl.data.sql.optimizers.name.NameRuleOptimizer;
import ch.epfl.data.sql.optimizers.name.manual_batching.ManualBatchingOptimizer;
