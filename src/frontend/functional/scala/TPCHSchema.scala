...
object TPCHSchema{
  ...
  type orders = Tuple9[Int,Int,String,Double,java.util.Date,String,String,String,String]
  type lineitems = Tuple16[Int,Int,Int,Int,Int,Double,Double,Double,String,String,java.util.Date,java.util.Date,java.util.Date,String,String,String]
  ...
  type suppliers = Tuple7[Int,String,String,Int,String, Double,String]
