...
object ScalaTPCH3Plan {
  ...
  def getQueryPlan(conf:java.util.Map[String,String]):QueryBuilder = {
    ...
    val COjoin= customers.join(orders, x=>x) (y=>y._2).map(t=> Tuple3(t._2._1, t._2._2, t._2._3))
    ...
    val agg= COLjoin.reduceByKey( t=> (1-t._2._2)*t._2._3, t=>Tuple3(t._1._1,t._1._2,t._1._3)) //List(0,1,2)
