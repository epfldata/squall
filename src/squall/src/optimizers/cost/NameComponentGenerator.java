...
public class NameComponentGenerator implements ComponentGenerator{
    ...
    private HashMap<String, CostParameters> _compCost =  new HashMap<String, CostParameters>();

    public NameComponentGenerator(Schema schema, TableAliasName tan, OptimizerTranslator ot, String dataPath, String extension){
        _schema = schema;
        _tan = tan;
        _ot = ot;
        _dataPath = dataPath;
