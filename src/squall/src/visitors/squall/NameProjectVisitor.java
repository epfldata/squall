...
public class NameProjectVisitor implements ExpressionVisitor, ItemsListVisitor{
    ...
    public void visit(Division dvsn) {
        if(!isRecognized(dvsn)){
            ...
            ValueExpression add = new expressions.Division(nc, left, right);
            _exprStack.push(add);
        }
    }
    ...
    public void visit(Multiplication m) {
        if(!isRecognized(m)){
            ...
            ValueExpression add = new expressions.Multiplication(nc, left, right);
            _exprStack.push(add);
        }
    }
    ...
    public void visit(Subtraction s) {
        if(!isRecognized(s)){
            ...
            ValueExpression add = new expressions.Subtraction(nc, left, right);
            _exprStack.push(add);
        }
    }
