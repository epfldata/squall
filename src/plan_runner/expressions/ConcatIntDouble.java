...
public class ConcatIntDouble implements ValueExpression<Long> {
	...
	public Long eval(List<String> tuple) {
		...
		long result = intValue1 + (intValue2 / (_divider * DOUBLE_TO_INT)) * 100000000L;
		//throw new RuntimeException("Ulazi su " + tuple.get(_intIndex) + " and  " + tuple.get(_dblIndex) + ", a izlaz je " + result);
		return result;
	}
	...
	public String toString() {
		...
		sb.append("ConcatIntString ").append(_intIndex).append(", ").append(_dblIndex);
		return sb.toString();
	}
