...
public class StormDstJoin extends StormBoltComponent {
	...
	private final BasicStore<ArrayList<String>> _firstRelationStorage, _secondRelationStorage;
	private final ProjectOperator _firstPreAggProj, _secondPreAggProj; // exists only
	// for
	// preaggregations
	// performed on the output of the aggregationStorage

	private final ChainOperator _operatorChain;
	private final List<Integer> _rightHashIndexes; // hash indexes from the right
	// parent
	...
	protected void performJoin(Tuple stormTupleRcv, List<String> tuple, String inputTupleHash,
			boolean isFromFirstEmitter, BasicStore<ArrayList<String>> oppositeStorage,
