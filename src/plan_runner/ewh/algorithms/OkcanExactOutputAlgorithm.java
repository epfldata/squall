...
public class OkcanExactOutputAlgorithm extends OkcanAlgorithm{
	...
	public OkcanExactOutputAlgorithm(int j, WeightFunction wf, int numXBuckets, int numYBuckets, Map map){
	...
	protected int getWeightLowerBound(JoinMatrix coarsenedMatrix, int numOfRegions) {
		return (int)(coarsenedMatrix.getTotalNumOutputs() / numOfRegions);
	}
