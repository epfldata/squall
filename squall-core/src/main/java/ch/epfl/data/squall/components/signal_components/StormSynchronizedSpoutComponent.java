...
public abstract class StormSynchronizedSpoutComponent extends BaseSignalSpout implements
		StormComponent, StormEmitter {
	private static final long serialVersionUID = 1L;
	private static Logger LOG = Logger.getLogger(StormSynchronizedSpoutComponent.class);
	...
	public StormSynchronizedSpoutComponent(ComponentProperties cp,
