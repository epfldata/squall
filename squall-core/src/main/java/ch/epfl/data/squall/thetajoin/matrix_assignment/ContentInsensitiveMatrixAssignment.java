...
public class ContentInsensitiveMatrixAssignment<KeyType> implements Serializable,
	...
	public static void main(String[] args) {
		final ContentInsensitiveMatrixAssignment x = new ContentInsensitiveMatrixAssignment(13, 7, 1, -1);
		LOG.info(x._r_S);
		LOG.info(x._r_T);
	...
	private static Logger LOG = Logger.getLogger(ContentInsensitiveMatrixAssignment.class);
	...
	public ContentInsensitiveMatrixAssignment(long sizeS, long sizeT, int r, long randomSeed) {
		if (randomSeed == -1)
			_rand = new Random();
		else
			_rand = new Random(randomSeed);
