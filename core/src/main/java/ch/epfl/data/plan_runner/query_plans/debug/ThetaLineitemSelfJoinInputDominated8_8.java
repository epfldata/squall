...
public class ThetaLineitemSelfJoinInputDominated8_8 {
	...
	/*
	 * For 0.01G Input: 15010 + 15010 Output = 56346
	 */
	...
	public ThetaLineitemSelfJoinInputDominated8_8(String dataPath,
		 ...
		 * "TRUCK")); ComparisonPredicate comp2 = new
		 * ComparisonPredicate(ComparisonPredicate.GREATER_OP,new
		 * ColumnReference(_ic, 4), new ValueSpecification(_ic,0)); AndPredicate
		 * and = new AndPredicate(comp1, comp2);
		 */
		ComparisonPredicate comp = new ComparisonPredicate(
