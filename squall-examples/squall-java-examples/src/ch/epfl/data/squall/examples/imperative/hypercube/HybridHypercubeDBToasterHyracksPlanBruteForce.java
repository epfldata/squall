...
public class HybridHypercubeDBToasterHyracksPlanBruteForce extends QueryPlan {
    ...
    public HybridHypercubeDBToasterHyracksPlanBruteForce(String dataPath, String extension, Map conf) {
        // -------------------------------------------------------------------------------------
        ...
        builder.addDimension("CUSTOMER", 0);
        builder.addDimension("column1", 1);
