...
public class HashHypercubeDBToasterUrlReachabilitySkewedRedis extends QueryPlan {
    private static Logger LOG = Logger.getLogger(HashHypercubeDBToasterUrlReachabilitySkewedRedis.class);
    ...
    public HashHypercubeDBToasterUrlReachabilitySkewedRedis(String dataPath, String extension, Map conf) {
