...
public class HybridHypercubeDBToasterTPCH9PartialPlan extends QueryPlan {

    private static Logger LOG = Logger.getLogger(HybridHypercubeDBToasterTPCH9PartialPlan.class);
    ...
    public HybridHypercubeDBToasterTPCH9PartialPlan(String dataPath, String extension, Map conf) {
        // -------------------------------------------------------------------------------------
