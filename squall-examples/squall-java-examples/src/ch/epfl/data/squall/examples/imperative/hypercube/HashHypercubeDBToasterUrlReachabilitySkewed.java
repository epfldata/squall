...
public class HashHypercubeDBToasterUrlReachabilitySkewed extends QueryPlan {
    private static Logger LOG = Logger.getLogger(HashHypercubeDBToasterUrlReachabilitySkewed.class);
    ...
    public HashHypercubeDBToasterUrlReachabilitySkewed(String dataPath, String extension, Map conf) {
