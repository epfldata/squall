...
public class HashHypercubeDBToasterTPCH9PartialPlanRedis extends QueryPlan {

    private static Logger LOG = Logger.getLogger(HashHypercubeDBToasterTPCH9PartialPlanRedis.class);
    ...
    public HashHypercubeDBToasterTPCH9PartialPlanRedis(String dataPath, String extension, Map conf) {
        // -------------------------------------------------------------------------------------
