...
public class TradionalHypercubeThetaHyracksPlan extends QueryPlan {
    private static Logger LOG = Logger.getLogger(TradionalHypercubeThetaHyracksPlan.class);
    ...
    public TradionalHypercubeThetaHyracksPlan(String dataPath, String extension, Map conf) {
