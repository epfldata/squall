...
public class HashHypercubeDBToasterHyracksPlanRedis extends QueryPlan {
    ...
    public HashHypercubeDBToasterHyracksPlanRedis(String dataPath, String extension, Map conf) {
        // -------------------------------------------------------------------------------------
