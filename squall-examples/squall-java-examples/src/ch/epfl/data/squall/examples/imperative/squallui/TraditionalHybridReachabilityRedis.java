...
public class TraditionalHybridReachabilityRedis extends QueryPlan {

    private static Logger LOG = Logger.getLogger(TraditionalHybridReachabilityRedis.class);
    ...
    public TraditionalHybridReachabilityRedis(String dataPath, String extension, Map conf) {
        // -------------------------------------------------------------------------------------
        // columns : From -> To
