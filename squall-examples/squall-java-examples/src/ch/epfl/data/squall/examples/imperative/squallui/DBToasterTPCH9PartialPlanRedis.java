...
public class DBToasterTPCH9PartialPlanRedis extends QueryPlan {

    private static Logger LOG = Logger.getLogger(DBToasterTPCH9PartialPlanRedis.class);
    ...
    public DBToasterTPCH9PartialPlanRedis(String dataPath, String extension, Map conf) {
        // -------------------------------------------------------------------------------------
        ...
        // PART: PARTKEY
        dbtBuilder.addRelation(relationPart, _lc);

        // LINEITEM: ORDERKEY, PARTKEY, SUPPKEY, QUANTITY, EXTENDEDPRICE, DISCOUNT
        dbtBuilder.addRelation(relationLineitem, _lc, _lc, _lc, _doubleConv, _doubleConv, _doubleConv);

        //PARTSUPP: PARTKEY, SUPPKEY, SUPPLYCOST
        dbtBuilder.addRelation(relationPartsupp, _lc, _lc, _doubleConv); 
