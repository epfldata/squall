...
public class HybridHypercubeDBToasterTPCH9PartialPlanRedis extends QueryPlan {

    private static Logger LOG = Logger.getLogger(HybridHypercubeDBToasterTPCH9PartialPlanRedis.class);
    ...
    public HybridHypercubeDBToasterTPCH9PartialPlanRedis(String dataPath, String extension, Map conf) {
        // -------------------------------------------------------------------------------------
        ...
        dbtBuilder.addRelation(relationLineitem, 
            ...
            new String[]{"ORDERKEY", "L_PARTKEY", "SUPPKEY", "QUANTITY", "EXTENDEDPRICE", "DISCOUNT"},
            new int[]{1});
