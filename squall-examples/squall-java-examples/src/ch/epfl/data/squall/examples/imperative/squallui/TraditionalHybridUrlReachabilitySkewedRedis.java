...
public class TraditionalHybridUrlReachabilitySkewedRedis extends QueryPlan {

    private static Logger LOG = Logger.getLogger(TraditionalHybridUrlReachabilitySkewedRedis.class);
    ...
    public TraditionalHybridUrlReachabilitySkewedRedis(String dataPath, String extension, Map conf) {
        // -------------------------------------------------------------------------------------
        // columns : From -> To
