...
public class DBToasterGoogleMostFailedMachineRedis extends QueryPlan {
    private static Logger LOG = Logger.getLogger(DBToasterGoogleMostFailedMachineRedis.class);
    ...
    public DBToasterGoogleMostFailedMachineRedis(String dataPath, String extension, Map conf) {
