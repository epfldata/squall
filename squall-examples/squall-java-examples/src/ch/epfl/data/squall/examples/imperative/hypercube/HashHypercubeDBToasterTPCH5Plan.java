...
public class HashHypercubeDBToasterTPCH5Plan extends QueryPlan {

    private static Logger LOG = Logger.getLogger(HashHypercubeDBToasterTPCH5Plan.class);
    ...
    public HashHypercubeDBToasterTPCH5Plan(String dataPath, String extension, Map conf) {
        computeDates();
