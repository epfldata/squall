...
public class SimpleAggregationPlan extends QueryPlan {
	...
	// -------------------------------------------------------------------------------------
	Component sorted1 = new DataSourceComponent("SORTED-1", conf)
		.setOutputPartKey(new int[] { 0 });
	Component sorted2 = new DataSourceComponent("SORTED-2", conf)
		.setOutputPartKey(new int[] { 0 });
	Component sorted3 = new DataSourceComponent("SORTED-3", conf)
		.setOutputPartKey(new int[] { 0 });

	// Component sorted1 = new DataSourceComponent("RANDOM-1",
	// conf).setOutputPartKey(new int[] { 0 });
	// Component sorted2 = new DataSourceComponent("RANDOM-2",
	// conf).setOutputPartKey(new int[] { 0 });
	// Component sorted = new DataSourceComponent("RANDOM-3",
	// conf).setOutputPartKey(new int[] { 0 });
	...
	arr.add(sorted2);
	arr.add(sorted3);
	// Component sorted = new DataSourceComponent("RANDOM",
	// conf).setOutputPartKey(new int[] { 0 });
