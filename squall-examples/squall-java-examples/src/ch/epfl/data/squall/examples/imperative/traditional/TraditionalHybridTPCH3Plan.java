...
public class TraditionalHybridTPCH3Plan extends QueryPlan {
    
    private static Logger LOG = Logger.getLogger(TraditionalHybridTPCH3Plan.class);
    ...
    public TraditionalHybridTPCH3Plan(String dataPath, String extension, Map conf) {
        // -------------------------------------------------------------------------------------
       ...
       HyperCubeJoinComponentFactory lastJoiner = 
        ...
        lastJoiner.addRelation(relationOrders, new Type[]{_ic, _ic, _dateConv, _ic}, 
            new String[]{"L_ORDERKEY", "CUSTKEY", "ORDERDATE", "SHIPPRIORITY"},
            new int[]{0}); 
