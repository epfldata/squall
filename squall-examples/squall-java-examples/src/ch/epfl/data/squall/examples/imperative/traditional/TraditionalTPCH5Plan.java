...
public class TraditionalTPCH5Plan extends QueryPlan {

    private static Logger LOG = Logger.getLogger(TraditionalTPCH5Plan.class);
    ...
    public TraditionalTPCH5Plan(String dataPath, String extension, Map conf) {
        computeDates();
