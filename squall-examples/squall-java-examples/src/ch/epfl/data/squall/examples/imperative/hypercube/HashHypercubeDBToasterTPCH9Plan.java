...
public class HashHypercubeDBToasterTPCH9Plan extends QueryPlan {

    private static Logger LOG = Logger.getLogger(HashHypercubeDBToasterTPCH9Plan.class);
    ...
    public HashHypercubeDBToasterTPCH9Plan(String dataPath, String extension, Map conf) {
        // -------------------------------------------------------------------------------------
