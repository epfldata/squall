...
public class DBToasterGoogleGoodnessScore extends QueryPlan {
    private static Logger LOG = Logger.getLogger(DBToasterGoogleGoodnessScore.class);
    ...
    public DBToasterGoogleGoodnessScore(String dataPath, String extension, Map conf) {
