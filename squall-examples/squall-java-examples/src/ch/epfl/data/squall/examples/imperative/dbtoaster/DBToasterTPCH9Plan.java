...
public class DBToasterTPCH9Plan extends QueryPlan {

    private static Logger LOG = Logger.getLogger(DBToasterTPCH9Plan.class);
    ...
    public DBToasterTPCH9Plan(String dataPath, String extension, Map conf) {
        // -------------------------------------------------------------------------------------
