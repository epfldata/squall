...
public class TraditionalHybridTPCH9PartialPlanRedis extends QueryPlan {

    private static Logger LOG = Logger.getLogger(TraditionalHybridTPCH9PartialPlanRedis.class);
    ...
    public TraditionalHybridTPCH9PartialPlanRedis(String dataPath, String extension, Map conf) {
        // -------------------------------------------------------------------------------------
