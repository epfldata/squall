...
public class DBToasterTPCH9PartialPlan extends QueryPlan {

    private static Logger LOG = Logger.getLogger(DBToasterTPCH9PartialPlan.class);
    ...
    public DBToasterTPCH9PartialPlan(String dataPath, String extension, Map conf) {
        // -------------------------------------------------------------------------------------
