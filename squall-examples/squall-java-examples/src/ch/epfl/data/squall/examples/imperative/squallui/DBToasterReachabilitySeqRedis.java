...
public class DBToasterReachabilitySeqRedis extends QueryPlan {
    private static Logger LOG = Logger.getLogger(DBToasterReachabilitySeqRedis.class);
    ...
    public DBToasterReachabilitySeqRedis(String dataPath, String extension, Map conf) {
